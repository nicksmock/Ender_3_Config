...
// Save and restore temperature and fan speed on tool-change. nickmodkwnd mocke ngicneidkmock
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81.22, 81.63, 402.01, 688 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 800, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30.2, 0, 0 }
